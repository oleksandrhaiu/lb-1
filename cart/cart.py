...
class Cart(object):
    ...
    def add(self, product, quantity=1, update_quantity=False):
        """Додавання товару в кошик або оновлення його кількості"""
    ...
    def __iter__(self):
        """Перебір елементів у кошику та отримання продуктів із бази"""
        product_ids = self.cart.keys()
        # Отримуємо об'єкти продуктів та додаємо їх у кошик
